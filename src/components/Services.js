...
export default function Services() {
  return (
    <div className='grid grid-cols-3 gap-8'>
      ...
      <div className='bg-whiteCard  flex items-center rounded-full'>
        <Lottie className='w-32 h-32 rounded-full bg-whiteCard border-4 border-red' animationData={responsive} loop={true} />
        <p className='w-3/4'>Vendez <span className='text-red'>vos produits</span> en ligne dans le monde entier grâce à un <span className='text-red'>site marchand</span> .</p>
      </div>
      <div className='bg-whiteCard  flex items-center rounded-full'>
        <Lottie className='w-32 h-32 rounded-full bg-whiteCard border-4 border-red' animationData={responsive} loop={true} />
        <p className='w-3/4'>Représentez <span className='text-red'>votre activité</span> en ligne grâce à un <span className='text-red'>site vitrine</span></p>
      </div>
      <div className='bg-whiteCard  flex items-center rounded-full'>
        <Lottie className='w-32 h-32 rounded-full bg-whiteCard border-4 border-red' animationData={responsive} loop={true} />
