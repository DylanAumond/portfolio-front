...
export default function Cgu() {
  return (
    <div className='mx-10 my-10 flex flex-col gap-4'>
        <h1>Mentions légales et politique de confidentialité</h1>

        <p>
            L'entreprise individuelle Dylan AUMOND, soucieuse des droits des individus, notamment au regard des
            ...
            actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.
        ...
        <h3>1.1 Site (ci-après « le site ») : DADEV</h3>


        <h3>1.2 Éditeur (ci-après « l'éditeur ») :</h3>

        <p>
            L'entreprise indivuduelle Dylan AUMOND  <br/>

            située : 11 Village De La Coquerie, Sainte-Mère-Église<br/>
            immatriculée au RCS de 913736864 <br/>
            n° de téléphone : 0768999016 <br/>
            adresse mail : dylanaumond@gmail.com
        </p>


        <h3>1.3 Hébergeur (ci-après « l'hébergeur ») :</h3>

        <p>DADEV est hébergé par O2switch, dont le siège social est situé CHE DES PARDIAUX 63000
        CLERMONT-FERRAND.</p>
        ...
        <p>
            Vos données sont collectées par l'entreprise individuelle Dylan AUMOND.
            <br/>
            <br/>
            <br/>
        ...
        <p>
            ...
            - numéro de téléphone
            <br/>
            - information relatives à une demande de de devis ou prestation
        </p>
        ...
        <p>
            ...
            <br/>
            11 Village De La Coquerie Sainte-Mère-Église.
            <br/>
            Ou par email, à l’adresse :
            <br/>
            dylanaumond@gmail.com
        </p>
        ...
        <p>
            ...
            consulter le site Internet de la CNIL : <a href='https://www.cnil.fr/'>https://www.cnil.fr/</a>
        </p>
        ...
        <p>
            ...
            cliquer sur le lien suivant : dylanaumond@gmail.com.
        </p>

        <p>
            Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection
            commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : dylanaumond@gmail.com.
            ...
            vie privée ou à la réputation des personnes. L'éditeur décline toute responsabilité à cet égard.
        ...
        <p>
            ...
            terminal utilisé (source : <a href='https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi'>https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi</a>).
        ...
        <p>
            ...
            une période de treize (13) mois. L'utilisateur a la possibilité de désactiver les cookies à tout moment.
        </p>
        ...
        <p>
            ...
            <br/>
            - access_token et refresh_token accèder à l'authentification et aux fonctionnalités.
        ...
        <p>
            ...
            pouvez laisser un message à l'adresse suivante : dylanaumond@gmail.com.
        </p>
